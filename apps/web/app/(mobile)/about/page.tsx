...
const About = () => {
  return (
    <section className="layout container">
      <article className="bg-white rounded-md border my-4 p-4  md:p-20 flex flex-col gap-4 max-w-3xl mx-auto leading-5">
        ...
        <main className="flex flex-col gap-4 text-justify">
          <p>
            <strong>{process.env["LOGO"]}</strong> is a leading online resource
            for mobile phone enthusiasts and professionals. Our website provides
            you with the latest news, reviews, and information about mobile
            phones, tablets, and other related products. Our goal is to be your
            go-to source for reliable and accurate information that helps you
            make informed decisions about mobile technology.
          </p>
          <p>
          ...
          <p>
            Thank you for visiting <strong>{process.env["LOGO"]}</strong> We
            hope you find our website informative, useful, and engaging. If you
            have any questions, comments, or suggestions, please don&apos;t
            hesitate to contact us. We look forward to hearing from you and hope
            you will continue to visit us for all your mobile technology-related
            needs.
          </p>
        </main>
      </article>
